  ...
  <el-row class="sectionDetail">
    <div v-if="version !== undefined && typeof version != 'undefined'">
      <div v-if="sectionDetail.type === WORD_CLOUD">
        <word-cloud-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      ...
      <div v-else-if="sectionDetail.type === PIE_CHART">
        <pie-chart-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      <div v-else-if="sectionDetail.type === LINE_CHART">
        <line-chart-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      <div v-else-if="sectionDetail.type === STATS">
        <stats-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      <div v-else-if="sectionDetail.type === SCATTER_CHART">
        <scatter-chart-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      <div v-else-if="sectionDetail.type === GRAPH_NETWORK">
        <graph-network-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>    
      <div v-else-if="sectionDetail.type === RADAR_CHART">
        <radar-chart-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>    
      <div v-else-if="sectionDetail.type === DEPENDENCY_CHART">
        <dependency-chart-section-detail :sectionDetail="sectionDetail" :versionId="versionId"/>
      </div>
      <div v-else>
        <el-alert
